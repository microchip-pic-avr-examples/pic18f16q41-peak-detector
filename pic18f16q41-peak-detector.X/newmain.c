...
//#pragma config RSTOSC = HFINTOSC_1MHZ// Reset Oscillator Selection (HFINTOSC with HFFRQ = 1 MHz and CDIV = 1:1)
//
//// CONFIG2
...
//
////Interrupt triggered if an edge was detected out of the OPA module
//void __interrupt(irq(CMP1)) edgeDetected(void)
//{
//    //Swap to the other Interrupt and start/stop ADC
//    if (CM1CON1bits.INTP)
//    {
//        LATA2 = 1;              //Turn on an LED
//        peakReady = PK_OPEN;    //Indicate the window is open
//        CM1CON1bits.INTN = 1;
//        CM1CON1bits.INTP = 0;
...
//    else
//    {
//        LATA2 = 0;                  //Turn off an LED
//        ADCON0bits.GO = 0;          //Abort the conversion
//        CM1CON1bits.INTP = 1;
//        CM1CON1bits.INTN = 0;
//        peakReady = PK_DONE;       //Indicate that the peak can be printed now
//    }
//    
//    PIR1bits.C1IF = 0;
//}
//
////Interrupt if the value is bigger than the previous highest
//void __interrupt(irq(ADT)) highPointInAQ(void)
//{
//    //Set new max
//    ADSTPTH = ADRESH;
//    ADSTPTL = ADRESL;
...
//void main(void) {
//    
//    //One of the Debug LEDs on the LPC Curiosity
//    TRISA2 = 0;
//    LATA2 = 0;
//    
//    //Init Print Output (9600 baud)
//    initUART();
//    
//    initDAC();
//    setTriggerLevel(127);       //Set the trigger level to 50% of the DAC
//    
//    initOPA();
//    initCMP();
//    initADCC();
...
//        
//        if (peakReady == PK_OPEN)
//        {
//            //Print a message
//            sendString("Peak Window Open", 1);
//            
//            //This statement covers a rare edge case
//            //Move the state machine
//            if (peakReady != PK_DONE)
//                peakReady = PK_RUNNING;
//        }
//        if (peakReady == PK_DONE)
//        {
